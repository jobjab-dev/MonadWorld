    ...
    return (
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="bg-pixel-purple-medium border border-white px-3 py-1 h-10 w-40 text-white font-vt323 rounded-none flex items-left justify-between"
          style={{ fontSize: '18px' }}
        >
          ...
          <div className="absolute right-0 mt-1 w-52 z-50">
            <div className="bg-pixel-purple-medium border border-white">
              <button 
                ...
                className="w-full px-4 py-2 text-white font-vt323 hover:bg-pixel-purple-light flex items-center justify-start border-b border-white/30"
                style={{ fontSize: '16px' }}
              >
              ...
              <button 
                ...
                className="w-full px-4 py-2 text-white font-vt323 hover:bg-pixel-purple-light flex items-center justify-start"
                style={{ fontSize: '16px' }}
              >
                <div className="bg-pixel-purple-light p-1 mr-2 flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="white">
